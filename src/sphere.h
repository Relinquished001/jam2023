...
void draw_sphere_internal()
{
    ...
    glDrawElements(GL_TRIANGLE_FAN, sphere_segments + 2, GL_UNSIGNED_SHORT, (GLvoid*)((sphere_segments + 2) * sizeof(uint16_t)));
    glDrawElements(GL_TRIANGLES, (sphere_rings - 1) * (sphere_segments * 6), GL_UNSIGNED_SHORT, (GLvoid*)((sphere_segments + 2) * 2 * sizeof(uint16_t)));
