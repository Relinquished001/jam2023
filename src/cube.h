...
void draw_cube()
{
    ...
    glVertexPointer(3, GL_FLOAT, sizeof(vertex_t), (GLvoid*)(0*sizeof(float) + (GLvoid*)cube_vertices));
    glTexCoordPointer(2, GL_FLOAT, sizeof(vertex_t), (GLvoid*)(3*sizeof(float) + (GLvoid*)cube_vertices));
    glNormalPointer(GL_FLOAT, sizeof(vertex_t), (GLvoid*)(5*sizeof(float) + (GLvoid*)cube_vertices));
    glColorPointer(4, GL_UNSIGNED_BYTE, sizeof(vertex_t), (GLvoid*)(8*sizeof(float) + (GLvoid*)cube_vertices));
